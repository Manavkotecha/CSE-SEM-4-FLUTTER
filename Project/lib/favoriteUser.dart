...
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:matrimony4/userDetail.dart';
// import 'database_helper.dart';
...
class _FavouriteUserState extends State<FavouriteUser> {
  ...
  void loadFavoriteUsers() async {
    try {
      List<Map<String, dynamic>> allUsers = await ApiService.fetchUsers();
      setState(() {
        favoriteUsers = allUsers.where((user) => user['isFavourite'] == 1).toList();
        filteredUsers = List.from(favoriteUsers);
      });
    } catch (e) {
                                          ...
                                          children: [
                                            Icon(
                                              gender.toLowerCase() == 'male'
                                                  ...
                                                  ? Icons.female
                                                  : Icons.transgender, // Shows transgender icon for 'other' or any unspecified gender
                                              size: 16,
                                              color: gender.toLowerCase() == 'male'
                                                  ? Colors.blue
                                                  : gender.toLowerCase() == 'female'
                                                  ? Colors.pink
                                                  : Colors.purple, // Assigns purple color for 'other' (transgender)
                                            ),
