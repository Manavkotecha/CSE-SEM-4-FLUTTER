...
// import 'package:matrimony4/database_helper.dart';
...
class AddUserState extends State<AddUser> {
  ...
  void initState() {
    ...
    if (widget.existingUser != null) {
      ...
      gender = user['gender'];
      if (user['hobbies'] != null && user['hobbies'] is String) {
                    ...
                    if (validateForm()) {
                      ...
                      try {
                        if (widget.existingUser != null) {
                          ...
                          await ApiService.updateUser(widget.existingUser!['id'], updatedUser);
                          // await DatabaseHelper.instance.updateUser(updatedUser);  // Commented out old method
                        } else {
                          // If adding a new user
                          await ApiService.addUser(updatedUser);
                          // await DatabaseHelper.instance.insertUser(updatedUser);  // Commented out old method
                        }

                        widget.onSaveUser(updatedUser);  // This part can remain if it's used to refresh the list
